 ...
 */
final class Version20220514072314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salles ADD CONSTRAINT FK_799D45AA3C5505E4 FOREIGN KEY (posseseur_id) REFERENCES user (id)');
    }
